...
<head>
    ...
    <title>Page d'inscription administrateur</title>
...
if (isset($_REQUEST['email'], $_REQUEST['password'])){
    ...
    $query = "INSERT into `administrateur` (email, password)
    ...
    <div class="container">
        <div class="signup-box">
            ...
            <form id="signup-form" action="" method="post">
                ...
                <p class="signin-link">Déjà un compte ? <a href="CONNEXION_Admin.php">Se connecter</a></p>
            </form>
